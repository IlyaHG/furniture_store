                                                            ...
                                                            <ul class="product__items--color__wrapper d-flex justify-content-center">
                                                                <li class="product__items--color__list"><a
                                                                        ...
                                                                        href="javascript:void(0)"><span
                                                                            class="visually-hidden">Color 1</span></a>
                                                                </li>
                                                                <li class="product__items--color__list"><a
                                                                        class="product__items--color__link two"
                                                                        href="javascript:void(0)"><span
                                                                            class="visually-hidden">Color 2</span></a>
                                                                </li>
                                                                <li class="product__items--color__list"><a
                                                                        class="product__items--color__link three"
                                                                        href="javascript:void(0)"><span
                                                                            class="visually-hidden">Color 3</span></a>
                                                                </li>
                                                                <li class="product__items--color__list"><a
                                                                        class="product__items--color__link four"
                                                                        href="javascript:void(0)"><span
                                                                            class="visually-hidden">Color 4</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        <div
                                                            ...
                                                            <a class="product__items--link" href="product-details.blade.php">
                                                                <img class="product__items--img product__primary--img"
                                                                     ...
                                                                     alt="product-img">
                                                                <img class="product__items--img product__secondary--img"
                                                                     src="{{ asset('img/product/product10.webp')}}"
                                                                     alt="product-img">
                                                            </a>
                                                            <div class="product__badge">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            ...
                                                            <p class="product__list--items__content--desc m-0">Lorem,
                                                                ...
                                                                deleniti officia culpa dolor esse consectetur
                                                                eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
                                                        ...
                                                        <ul class="rating product__list--rating d-flex">
                                                            ...
                                                            <li class="rating__list"><span class="rating__list--text">( 5.0)</span>
                                                            </li>
                                                        </ul>
