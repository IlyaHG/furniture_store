                ...
                <div class="product__grid--inner">
                    <div class="product__items product__items--grid d-flex align-items-center">
                        ...
                        <div class="product__items--grid__content">
                            <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Modern Chair</a></h3>
                    ...
                    <div class="product__items product__items--grid d-flex align-items-center">
                        ...
                        <div class="product__items--grid__content">
                            <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Plastic Chair</a></h3>
                            <div class="product__items--price">
                                <span class="current__price">$165.00</span>
                            </div>
                            <div class="product__items--color">
                    ...
                    <div class="product__items product__items--grid d-flex align-items-center">
                        ...
                        <div class="product__items--grid__content">
                            <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Design Rooms</a></h3>
                            <div class="product__items--price">
                                <span class="current__price">$165.00</span>
                            </div>
                            <div class="product__items--color">
                                ...
                                <li class="header__menu--items mega__menu--items">
                                    ...
                                    <ul class="header__mega--menu d-flex">
                                        ...
                                        <li class="header__mega--menu__li">
                                            ...
                                            <ul class="header__mega--sub__menu">
                                                <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="product-details.blade.php">Standard Product</a></li>
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li">
                                    ...
                                    <ul class="offcanvas__sub_menu">
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-details.blade.php">Standard Product</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-variable.blade.php">Video Product</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-variable.blade.php">Variable Product</a></li>
                                        ...
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-gallery.blade.php">Product Gallery</a></li>
                                    </ul>
                                </li>
                                <li class="offcanvas__sub_menu_li">
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.blade.php"><img src="assets/img/product/product1.webp" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                        <h4 class="minicart__subtitle"><a href="product-details.blade.php">The is Garden Vegetable.</a></h4>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.blade.php"><img src="assets/img/product/product2.webp" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                        <h4 class="minicart__subtitle"><a href="product-details.blade.php">Fresh Tomatoe is organic.</a></h4>
                                    ...
                                    <div class="product__section--inner product__grid--inner">
                                        <div class="row row-cols-xxl-4 row-cols-xl-3 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                            ...
                                            <li class="product__items--color__list"><a class="product__items--color__link four" href="javascript:void(0)"><span class="visually-hidden">Color 4</span></a></li>
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Fashion Plastic Chair</a></h3>
                                                        <div class="product__items--price">
                                            ...
                                            <li class="product__items--color__list"><a class="product__items--color__link four" href="javascript:void(0)"><span class="visually-hidden">Color 4</span></a></li>
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Modern Swivel Chair</a></h3>
                                                        <div class="product__items--price">
                                            ...
                                            <li class="product__items--color__list"><a class="product__items--color__link four" href="javascript:void(0)"><span class="visually-hidden">Color 4</span></a></li>
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Design Living Sofa</a></h3>
                                                        <div class="product__items--price">
                                            ...
                                            <li class="product__items--color__list"><a class="product__items--color__link four" href="javascript:void(0)"><span class="visually-hidden">Color 4</span></a></li>
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Plastic Chair Wooden</a></h3>
                                                        <div class="product__items--price">
                                            ...
                                            <li class="product__items--color__list"><a class="product__items--color__link four" href="javascript:void(0)"><span class="visually-hidden">Color 4</span></a></li>
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Folding Tables Chairs</a></h3>
                                                        <div class="product__items--price">
                                            ...
                                            <li class="product__items--color__list"><a class="product__items--color__link four" href="javascript:void(0)"><span class="visually-hidden">Color 4</span></a></li>
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Modern Fabric Chair</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">$165.00</span>
                                                            <span class="old__price">$210.00</span>
                                                        </div>
                                            ...
                                            <li class="product__items--color__list"><a class="product__items--color__link four" href="javascript:void(0)"><span class="visually-hidden">Color 4</span></a></li>
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Globe Electric Lamp</a></h3>
                                                        <div class="product__items--price">
                                            ...
                                            <li class="product__items--color__list"><a class="product__items--color__link four" href="javascript:void(0)"><span class="visually-hidden">Color 4</span></a></li>
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="product-details.blade.php">Design Rooms Sofa</a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">$155.00</span>
                                                ...
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            ...
                                                            <h4 class="product__list--items__content--title mb-15"><a href="product-details.blade.php">Larger Minimal Wooden Chair</a></h4>
                                                ...
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            ...
                                                            <h4 class="product__list--items__content--title mb-15"><a href="product-details.blade.php">White Minimalist Combo Sofa</a></h4>
                                                            <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
                                                ...
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            ...
                                                            <h4 class="product__list--items__content--title mb-15"><a href="product-details.blade.php">Modern Swivel Chair</a></h4>
                                                            <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            <span class="product__items--content__subtitle mb-5">Wooden</span>
                                                            <h4 class="product__list--items__content--title mb-15"><a href="product-details.blade.php">Modern Stylish Single Sofa</a></h4>
                                                            <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
                                                ...
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            ...
                                                            <h4 class="product__list--items__content--title mb-15"><a href="product-details.blade.php">New Furniture Tree Planet</a></h4>
                                                            <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    <div class="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div class="product__list--items__content">
                                                            <span class="product__items--content__subtitle mb-5">Wooden</span>
                                                            <h4 class="product__list--items__content--title mb-15"><a href="product-details.blade.php">Single Stylish Mini Chair</a></h4>
                                                            <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                        </div>
                                                    </div>
                                                    <div class="product__list--items__right">
