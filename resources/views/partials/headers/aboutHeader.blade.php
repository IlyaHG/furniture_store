                        ...
                        <ul class="d-flex">
                                ...
                                <ul class="header__mega--menu d-flex">
                                    ...
                                    <li class="header__mega--menu__li">
                                        ...
                                        <ul class="header__mega--sub__menu">
                                            ...
                                            <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="404.blade.php">404 Page</a></li>
                                    ...
                                    <li class="header__mega--menu__li">
                                        ...
                                        <ul class="header__mega--sub__menu">
                                            ...
                                            <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="404.blade.php">Error Page</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="header__menu--items style3">
                                ...
                                <ul class="header__sub--menu">
                                    ...
                                    <li class="header__sub--menu__items"><a href="404.blade.php" class="header__sub--menu__link">Error Page</a></li>
                                </ul>
                            </li>
                            <li class="header__menu--items style3">
                ...
                <ul class="offcanvas__menu_ul">
                        ...
                        <ul class="offcanvas__sub_menu">
                            ...
                            <li class="offcanvas__sub_menu_li">
                                ...
                                <ul class="offcanvas__sub_menu">
                                    ...
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="404.blade.php">404 Page</a></li>
                            ...
                            <li class="offcanvas__sub_menu_li">
                                ...
                                <ul class="offcanvas__sub_menu">
                                    ...
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="404.blade.php">Error Page</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            ...
                            <li class="offcanvas__sub_menu_li"><a href="404.blade.php" class="offcanvas__sub_menu_item">Error Page</a></li>
                        </ul>
                    </li>
