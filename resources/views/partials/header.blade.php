                        ...
                        <li class="language__currency--list">
                            <a class="language__switcher text-white" href="#">
                                <img class="language__switcher--icon__img"
                                     src="{{asset('img/icon/language-icon.webp')}}" alt="currency">
                                <span>Language</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05"
                                     viewBox="0 0 9.797 6.05">
                                    <path d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z"
            ...
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <a class="main__logo--link" href="{{route('home')}}"><img class="main__logo--img"
                                                                              src="{{asset('img/logo/nav-log.webp')}}"
                                                                              alt="logo-img"></a>
                </div>
                    ...
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="{{route('home')}}">Home <span
                                        class="menu__plus--icon">+</span></a>
                                <ul class="header__sub--menu">
                                    <li class="header__sub--menu__items"><a href="{{route('home')}}"
                                                                            class="header__sub--menu__link">Home One</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="header__menu--items mega__menu--items">
                                <a class="header__menu--link" href="shop.html">Catalog <span
                                        class="menu__plus--icon">+</span></a>
                                <ul class="header__mega--menu d-flex">
                                    <li class="header__mega--menu__li">
                                        <span class="header__mega--subtitle">Furniture</span>
                                    ...
                                    <li class="header__mega--menu__li">
                                        ...
                                        <ul class="header__mega--sub__menu">
                                            <li class="header__mega--sub__menu_li"><a
                                                    class="header__mega--sub__menu--title" href="{{route('products')}}">Men's
                                                    outerwear</a></li>
                                    ...
                                    <li class="header__mega--menu__li">
                                        <span class="header__mega--subtitle">Kids</span>
                                        <ul class="header__mega--sub__menu">
                                            <li class="header__mega--sub__menu_li"><a
                                                    class="header__mega--sub__menu--title" href="compare.html">Kid's
                                                    outerwear</a></li>
                                            ...
                                            {{--                                            <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="{{route('wishlist')}}">Wishlist Page</a></li>--}}
                            ...
                            <li class="header__menu--items">
                                <a class="header__menu--link " href="#">Pages <span
                                        class="menu__plus--icon">+</span></a>
                                <ul class="header__sub--menu">
                                    <li class="header__sub--menu__items"><a href="{{route('about_us')}}"
                                    ...
                                    <li class="header__sub--menu__items"><a href="portfolio.html"
                                            ...
                                            Page</a></li>
                                    <li class="header__sub--menu__items"><a href="{{route('wishlist')}}"
                            ...
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="{{route('about_us')}}">About US </a>
                            </li>
                            <li class="header__menu--items">
                    ...
                    <ul class="d-flex">
                        @if (auth()->check() == false)
                            <li class="header__account--items  header__account--search__items">
                                <a class="header__account--btn search__open--btn" href="{{route('login')}}">
            ...
            <nav class="offcanvas__menu">
                <ul class="offcanvas__menu_ul">
                    ...
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            ...
                            <li class="offcanvas__sub_menu_li">
                                ...
                                <ul class="offcanvas__sub_menu">
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item"
                                                                          href="product-details.html">Standard
                                            Product</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item"
                                                                          href="product-variable.html">Video Product</a>
                                    </li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item"
                            ...
                            <li class="offcanvas__sub_menu_li">
                                ...
                                <ul class="offcanvas__sub_menu">
                                    ...
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item"
                                                                          href="404.blade.php">404 Page</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item"
                            ...
                            <li class="offcanvas__sub_menu_li">
                                ...
                                <ul class="offcanvas__sub_menu">
                                    ...
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item"
                                                                          href="{{route('wishlist')}}">Wishlist Page</a></li>
                                    <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item"
                                                                          href="404.blade.php">Error Page</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            <li class="offcanvas__sub_menu_li"><a href="{{route('about_us')}}"
                            ...
                            <li class="offcanvas__sub_menu_li"><a href="{{route('wishlist')}}" class="offcanvas__sub_menu_item">Wishlist
                                    Page</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="login.html" class="offcanvas__sub_menu_item">Login
                                    Page</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="404.blade.php" class="offcanvas__sub_menu_item">Error
                                    Page</a></li>
                        </ul>
                    </li>
