                        ...
                        <div class="main checkout__mian">
                            <form action="#">
                                ...
                                <div class="checkout__content--step__footer d-flex align-items-center">
                                    <a class="continue__shipping--btn primary__btn border-radius-5" href="main/index.blade.php">Continue To Shipping</a>
                                    <a class="previous__link--content" href="cart.blade.php">Return to cart</a>
                                </div>
                            </form>
                        </div>
                    </div>
